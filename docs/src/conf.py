...
# -*- coding: utf-8 -*-
#
# Simple-10GbE-RUDP-KCU105-Example documentation build configuration file, created by
...
htmlhelp_basename = 'Simple10GbERUDPKCU105Exampledoc'
...
latex_documents = [
    (master_doc, 'example.tex', 'Simple-10GbE-RUDP-KCU105-Example Documentation',
...
man_pages = [
    (master_doc, 'example', 'Simple-10GbE-RUDP-KCU105-Example Documentation',
     [author], 1)
]
